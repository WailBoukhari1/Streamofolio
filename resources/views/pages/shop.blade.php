                        ...
                        <figure class="group relative overflow-hidden bg-gray-100">
                            ...
                            <div
                                ...
                                <form action="{{ route('cart.add') }}" method="POST">
                                    ...
                                    @else
                                        <button type="button"
                                            class="inline-flex text-center font-bold leading-none transition-colors uppercase justify-center gap-x-3 py-4 px-4 md:py-[18px] lg:px-8 text-sm text-white bg-gray-300 hover:bg-gray-300/90 basis-full md:basis-1/2 lg:basis-2/5">
                                            Out of Stock
                                        </button>
                                    @endif
                                </form>
