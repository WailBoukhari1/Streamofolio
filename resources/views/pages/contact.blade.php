          ...
          <div class="container">
              ...
              <div class="grid grid-cols-12 gap-x-6 gap-y-14 md:gap-y-20 md:gap-x-6 lg:gap-x-7.5">
                  ...
                  <div class="col-span-full lg:col-span-4 lg:pr-20 xl:pr-32">
                      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-y-8 lg:gap-y-14">
                          <div>
                              <div>
                                  <div
                                      class="leading-none text-gray-900 dark:text-white text-lg md:text-xl xl:text-2xl xl:leading-none font-bold tracking-tighter [&_span]:text-primary uppercase mb-2">
                                      <a class="hover:text-primary transition-colors"
                                          href="mailto:affiliates@magix.com">affiliates<span>@</span>magix.com</a>
                                  </div>
                                  <h6 class="uppercase font-bold text-gray-600 leading-none tracking-tight">Affiliates
                                      Inquiries</h6>
                              </div>
                          </div>
                          <div>
                              <div>
                                  ...
                                  <h6 class="uppercase font-bold text-gray-600 leading-none tracking-tight">Fanmail
                                      Address</h6>
                              </div>
                          </div>
                      </div>
                      ...
                      <ul class="vv-social-list-color flex flex-wrap gap-3">
                          <li>
                              <a class="inline-flex h-10 w-10 items-center justify-center bg-primary text-white transition-all hover:scale-110 hover:opacity-80"
                  ...
                  <div class="col-span-full lg:col-span-8">
                      ...
                      @endif
                      <h2
                          class="text-gray-900 dark:text-white leading-none tracking-tighter font-bold uppercase text-2xl sm:text-3xl md:text-4xl lg:text-5xl lg:leading-none xl:text-5.5xl xl:leading-[0.92em] mb-6 sm:mb-8 md:mb-9 lg:mb-10 xl:mb-12">
                          Something in your mind?<br>
                          <span class="text-primary">Send me a message!</span>
                      </h2>
                      <form class="grid grid-cols-12 gap-x-5 md:gap-x-6 lg:gap-x-7.5 gap-y-7.5"
                          ...
                          <div class="col-span-full md:col-span-6">
                              ...
                              <input
                                  ...
                                  type="text" name="name" id="name" value="" placeholder="">
                          ...
                          <div class="col-span-full md:col-span-6">
                              ...
                              <input
                                  class="px-4 py-2 border-base bg-white bg-[length:18px_18px,_38px_38px] bg-[position:right_16px_center,_right_6px_center] bg-no-repeat font-medium leading-8 tracking-tight text-gray-900 transition-all duration-150 placeholder:font-normal placeholder:text-gray-500/60 focus:border-accent focus:bg-white focus:text-gray-900 focus:outline-0 focus:ring-0 dark:border-gray-600 dark:group-[.is-success]:bg-input-success dark:bg-gray-800 dark:text-white dark:placeholder:text-gray-500/80 dark:focus:border-accent dark:focus:bg-gray-900 w-full"
                                  type="email" name="email" id="email" value="" placeholder="">
                              <p class="group-[.is-error]:block mt-2 hidden text-xs text-danger">
